// Modelo de datos y datos simulados del prototipo "Asistente Diario".
// Preparado para ser sustituido más adelante por una base de datos real.

import { uid } from "./asistente";
...
export const USUARIOS_ADMIN: UsuarioAdmin[] = [
  { id: uid(), nombre: "Gustavo Ugarte", numero: "+591 700 12345", registro: desplazarDias(-45), estado: "activo", actividades: 128 },
  { id: uid(), nombre: "Carlos Mamani", numero: "+591 712 98765", registro: desplazarDias(-38), estado: "activo", actividades: 94 },
  { id: uid(), nombre: "María Fernández", numero: "+591 767 45612", registro: desplazarDias(-30), estado: "activo", actividades: 76 },
  { id: uid(), nombre: "Luis Quispe", numero: "+591 733 11223", registro: desplazarDias(-21), estado: "inactivo", actividades: 12 },
  { id: uid(), nombre: "Ana Rojas", numero: "+591 750 33445", registro: desplazarDias(-10), estado: "activo", actividades: 41 },
  { id: uid(), nombre: "Pedro Salazar", numero: "+591 799 55667", registro: desplazarDias(-4), estado: "suspendido", actividades: 3 },
];

export const ACTIVIDAD_ADMIN = [
  { id: uid(), usuario: "Gustavo Ugarte", accion: "Creó un recordatorio por nota de voz", fecha: `${hoyISO()} 08:02`, estado: "exitoso" as const },
  { id: uid(), usuario: "María Fernández", accion: "Activó la automatización “Resumen diario”", fecha: `${hoyISO()} 07:44`, estado: "exitoso" as const },
  { id: uid(), usuario: "Carlos Mamani", accion: "Consultó su agenda del día", fecha: `${hoyISO()} 07:15`, estado: "exitoso" as const },
  { id: uid(), usuario: "Luis Quispe", accion: "Mensaje no interpretado", fecha: `${desplazarDias(-1)} 22:31`, estado: "error" as const },
  { id: uid(), usuario: "Ana Rojas", accion: "Guardó información en memoria", fecha: `${desplazarDias(-1)} 18:05`, estado: "exitoso" as const },
];
...
export const INTEGRACIONES = [
  ...
  { nombre: "Base de datos", descripcion: "Persistencia de tareas, eventos, memoria e historial.", estado: "Pendiente de conexión" },
